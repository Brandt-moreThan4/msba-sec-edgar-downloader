...
class Downloader:
    ...
    def get_filings(
        ...
        if is_gvkey: # If the ticker or cik is actually a gvkey, then we first want to convert it to 
            ticker_or_cik = get_cik_from_gvkey(ticker_or_cik,date=before) 
        ...
        filings_to_fetch = get_filing_urls_to_download(
            ...
            amount,
            after,
            '2023-01-01', # this is the before date. Super slopper, but we always grab all urls and filter the rest out later
            # before,
            include_amends,
            query,
        )
        ...
        for filing in filings_to_fetch:
            ...
            # Add code here to inseret ticker & gvkey
    ...
    def get2(
        ...
        *,
        ...
        if is_gvkey: # If the ticker or cik is actually a gvkey, then we first want to convert it to 
            ticker_or_cik = get_cik_from_gvkey(ticker_or_cik,date='2022-03-05') # Change the default day to be today
